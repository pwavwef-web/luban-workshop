(() => {
  ...
  // src/admin-qr.js
  var DEFAULT_CELL_SIZE = 8;
  var DEFAULT_MARGIN = 4;
  var DEFAULT_DOWNLOAD_SIZE = 1400;
  var PRINT_CELL_SIZE = 12;
  ...
  function sanitizeFilename(filename, extension) {
    const safeBase = String(filename || "special-menu-qr").replace(new RegExp(`\\.${extension}$`, "i"), "").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "").slice(0, 80) || "special-menu-qr";
