  ...
  function footerHtml(chinese) {
    ...
    const exploreLinks = chinese
      ...
      : [
          ['', labels.campaigns],
          ['bao/', labels.bao],
          ['flyers/', labels.flyers],
          ['student-election/', labels.electionKit],
          ['https://lubanrestaurant.com/menu.html', labels.restaurantMenu],
        ];
    ...
    const legalLinks = chinese
      ...
      : [
          ['https://lubanrestaurant.com/terms-of-use.html', labels.terms],
          ['https://lubanrestaurant.com/privacy-policy.html', labels.privacy],
        ];

    const reserveHref = chinese
      ? siteUrl('chinese/events-and-catering.html')
      : 'https://lubanrestaurant.com/events-and-catering.html#reservation';
    const secondaryHref = chinese
      ? siteUrl('chinese/menu.html')
      : 'https://lubanrestaurant.com/#menu';
