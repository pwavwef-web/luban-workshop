...
// Vendored into the Next.js admin app. The script + Bao avatar + logo are served
// locally (resolved via import.meta.url), but public-site links, the QR image, and
// the checkout redirect should resolve against the live restaurant site.
const SITE_ROOT = new URL('https://lubanrestaurant.com/');
...
const CONTACT = {
  ...
  contactPage: 'https://lubanrestaurant.com/contact-us.html',
  reservationPage: 'https://lubanrestaurant.com/events-and-catering.html#reservation',
  menuPage: 'https://lubanrestaurant.com/menu.html',
  qrPage: 'https://lubanrestaurant.com/assets/qr-codes/index.html',
